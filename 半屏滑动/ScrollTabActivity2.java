...
import com.kuyuzhiqi.testdemo01.ui.fragment.TaskFragment;
import com.kuyuzhiqi.testdemo01.ui.fragment.ToolsFragment;
import com.kuyuzhiqi.testdemo01.utils.DisplayUtils;
import com.kuyuzhiqi.testdemo01.utils.TabViewUtils;
import com.kuyuzhiqi.testdemo01.widget.ScrollLinearLayout2;
...
public class ScrollTabActivity2 extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        TabHost.TabSpec tabSpec1 = mTabHost.newTabSpec(ToolsFragment.class.getName())
                .setIndicator(TabViewUtils.getTabItemView(this, R.mipmap.ic_task_select, "工具", R.color.colorPrimary));
